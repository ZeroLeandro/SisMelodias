Public Class Ddetalle_Venta
    ...
    Dim ctx As SisMelodiasEntities = New SisMelodiasEntities
    ...
    Public Function mostrarDetalle(ByVal idFac As Integer, ByVal grid As DataGridView)
        Try
            Dim datos = (From df In ctx.detalle_venta
                         ...
                         Select idVenta = f.Id_venta, Id_Detalle = df.Id_detalle_venta, idPro = df.Id_producto, Producto = j.nombre_producto, Categoria = cat.descripcion_cat, Cantidad_Comprada = df.cantidad, PrecioUnitario = j.precio, SubTotal = (j.precio * df.cantidad)).ToList
