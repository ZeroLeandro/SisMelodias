            ...
            If bc IsNot Nothing Then
                ...
                Select Case bc.HeaderText
                    Case "Seleccionar" 'Nombre del boton / celda
                        ...
                        TBHash.Text = DGV1.Rows(cell.RowIndex).Cells(12).Value
                        CBPerfil.SelectedValue = DGV1.Rows(cell.RowIndex).Cells(9).Value
                        CBEstado.Text = DGV1.Rows(cell.RowIndex).Cells(11).Value
                        BEditar.Enabled = True
                        Exit Select
                End Select
