...
Public Class MDISuperAdmin
    ...
    Dim cn As New SisMelodiasEntities
    ...
    Private Sub ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem1.Click
        Try
            ...
            nombre = "SisMelodias" & Now.Day & "_" & Now.Month & "_" & Now.Year & "_" & Now.Hour & "_" & Now.Minute & ".bak"
            Dim destino_backup As String = "C:\Backup\"

            Using cnx As New SqlConnection("Data Source=MAURICIO\SQLEXPRESS01;Initial Catalog=SisMelodias;Integrated Security=True;")

                cnx.Open()


                Using cmd As New SqlCommand("BACKUP DATABASE [SisMelodias] TO DISK='" & destino_backup & " " & nombre & "' ", cnx)
