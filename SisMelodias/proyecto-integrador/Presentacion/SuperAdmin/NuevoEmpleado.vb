Public Class NuevoEmpleado
    ...
    Private Sub TBDni_keyPress(sender As Object, e As KeyPressEventArgs) Handles TBDni.KeyPress
        ...
        ElseIf TBDni.Text.Length >= 8 Then
            e.Handled = True
            MessageBox.Show("Solo se admiten 8 caracteres", "Validación de cantidad de caracteres", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End If
    End Sub
    ...
    Private Sub TBTel_TextChanged(sender As Object, e As KeyPressEventArgs) Handles TBTel.KeyPress
        ...
        End If
    End Sub
    Private Sub TBTel_keyPress(sender As Object, e As KeyPressEventArgs) Handles TBDni.KeyPress
        If Char.IsControl(e.KeyChar) Then
            Return

        ElseIf TBTel.Text.Length >= 10 Then
            e.Handled = True
            MessageBox.Show("Solo se admiten 8 caracteres", "Validación de cantidad de caracteres", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End If
    End Sub
    ...
    Private Sub BAgregar_Click(sender As Object, e As EventArgs) Handles BAgregar.Click
        ...
        Dim msjTxt1 As String = "La contraseña debe tener al menos 8 caracteres "
        ...
        ElseIf TBCont.Text.Length < 8 Then
            MsgBox(msjTxt1, MsgBoxStyle.Critical, Title:="Error")
